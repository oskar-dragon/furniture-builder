...
import { FurnitureHeader } from '@/feature/furniture-builder';
  ...
  return (
    <PageWrapper className="min-h-screen">
      <div className="flex flex-col shadow-sm lg:min-h-[calc(100vh-8.5rem)] lg:flex-row lg:bg-gray-100">
        ...
        <div className="rounded-b-lg bg-white p-4 shadow lg:mb-8 lg:mr-8 lg:max-h-[calc(100%-8rem)] lg:basis-[380px]">
